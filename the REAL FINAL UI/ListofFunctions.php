...
<?php
	if($Security == 'Administrator' || $Security == 'Owner'){
		...
		echo "<li><button class='button redbutton'>Order Entry</button></li>";
		echo "</form>";
		...
		echo "<li><button class='button bluebutton'>Customer Management</button></li>";
		echo "</form>";
		echo "<form action='UserManagement.php' method='get'>";
		echo "<li><button class='button redbutton'>User Management</button></li>";
		echo "</form>";
	}
	elseif($Security == 'Salesperson'){
		...
		echo "</form>";
		echo "<form action='CustomerManagement.php' method='get'>";
		echo "<li><button class='button redbutton'>Customer Management</button></li>";
		echo "</form>";
		echo "<form action='UserManagement.php' method='get'>";
	...
	elseif($Security == 'Manager'){
		echo "<form action='ProductSearch.php' method='get'>";
		echo "<li><button class='button redbutton'>Product Search</button></li>";
		echo "</form>";
		echo "<form action='InventoryManagement.php' method='get'>";
		echo "<li><button class='button bluebutton'>Inventory Management</button></li>";
		echo "</form>";
		echo "<form action='UserManagement.php' method='get'>";
		echo "<li><button class='button redbutton'>User Management</button></li>";
		echo "</form>";
